...
选择 Booru
在 Tags to Search (Pre) 填写搜索标签（逗号分隔，如 1girl,blue_eyes,long_hair）
点击 生成提示词
生成结果会显示在输出框，并可写入 WebUI prompt
点击 WebUI Generate 开始出图
...
只保留单人：
包含：1girl
排除：2girls,multiple_girls
指定发色：
包含：1girl,blue_hair
排除：blonde_hair,red_hair
凭证与隐私
